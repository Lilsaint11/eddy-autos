    ...
    <div className="flex-1 flex flex-col items-center justify-center text-white text-center px-4 relative lg:pt-40 max-lg:pt-30 max-lg:pb-30">
      ...
      <div className="hidden lg:flex absolute left-8 top-1/2 -translate-y-1/2 flex-col items-center gap-6 z-40 animate-fade-in mt-20">
        ...
        <div className="bg-white/9 w-10 h-10 rounded-full flex justify-center items-center">
          <a
            href="#"
            className="text-zinc-400 hover:text-red-500 transition-all duration-300 hover:scale-120"
            title="Instagram"
          >
            <svg
              className="w-5 h-5"
      ...
      <div className="max-w-5xl mx-auto max-lg:pt-20">
        ...
        <p className="text-lg md:text-xl text-gray-300 font-light mb-12 max-w-2xl mx-auto drop-shadow-lg">
          Discover premium vehicles at unbeatable prices. The road to your
          next adventure starts right here.
        </p>

        {/* Search */}
        <form
          onSubmit={handleSearch}
          className="bg-white/10 backdrop-blur-md border border-white/20 p-2 md:py-4 md:px-7 flex md:flex-row gap-2 md:gap-4 w-full max-w-4xl shadow-2xl mx-auto justify-center items-center rounded-full"
        >
          <input
            type="text"
            value={searchTerm}
            onChange={(e) => setSearchTerm(e.target.value)}
            className="w-full bg-transparent text-white outline-none placeholder:text-[#bbb] px-3"
          ...
          <button
            type="submit"
            className="flex items-center justify-center shrink-0 text-white hover:text-red-500 transition-colors cursor-pointer"
            aria-label="Search"
          >
            <Search size={24} />
          </button>
